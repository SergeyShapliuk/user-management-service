...
import { IdType, PayloadType } from './id';
...
export type RequestWithParamsAndUser<P, U extends PayloadType> = Request<
  P,
  {},
  {},
  {},
  U
>;
export type RequestWithParamsAndBodyAndUser<
  P,
  B,
  U extends PayloadType,
> = Request<P, {}, B, {}, U>;
